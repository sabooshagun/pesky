<div class="jumbotron">
    <form class="form-horizontal" action="{{route('fogging_data_upload')}}" method="post"
    ...
    <div class="row">
        <div class="col-sm-offset-4 col-sm-8">
            <a href="{{str_replace("/index.php","",url("fogging_format.xlsx"))}}" download> Download Template </a>
        </div>
    </div>
</div>